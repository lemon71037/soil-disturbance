...
from models import CNNClassifier, CNN2DClassifier, TransformerClassifier
...
train_data = zwy_train + zwy2_train
test_data = zwy_test + zwy2_test
...
# train_data = yqcc_train + yqcc2_train + zwy_train + zwy2_train + zyq_train + zyq2_train + j11_md_train + j11_2_train
